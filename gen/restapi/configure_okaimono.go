...
func configureFlags(api *handlers.OkaimonoAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *handlers.OkaimonoAPI) http.Handler {
	...
	if api.CreateMembershipCardHandler == nil {
		api.CreateMembershipCardHandler = handlers.CreateMembershipCardHandlerFunc(func(params handlers.CreateMembershipCardParams) middleware.Responder {
